...
public class ChartComponent extends HorizontalLayout {
    ...
    private Chart getChart(List<String> o, final int emplCount) {
        ...
        set.forEach(item -> series.add(new DataSeriesItem(item + " %: ", (double) Collections.frequency(o, item) / emplCount * 100)));
